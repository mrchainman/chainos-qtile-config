...
keys = [
    ...
    Key([mod], "space", lazy.spawn("nwggrid -client"), desc="Launch Nwggrid"),
    ...
    Key([], "l", lazy.group["scratchpad"].dropdown_toggle("nchat"), desc="Toggle Nchat"),
    ...
    Key([], "o", lazy.group["scratchpad"].dropdown_toggle("onenote"), desc="Toggle Onenote"),
